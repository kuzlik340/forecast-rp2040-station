...
int interval_for_pressure = 36000; //interval for logging pressure into array(this interval keeps logging of pressure every 30 minutes)
int interval_for_temperature = 18000; //interval for logging temperature into array(this interval keeps logging of temperature every 15 minutes)
